                                ...
                                <div class="col-md-3">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <img src="<?php if(empty($pfrow['photo'])){echo "upload/noimage.jpg";} else{echo $pfrow['photo'];} ?>" style="height:225px; width:100%;">
                                        </div>
                            ...
                            ?>
                                <div class="col-md-3">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <img src="<?php if($prow['photo']==''){echo "upload/noimage.jpg";} else{echo $prow['photo'];} ?>" style="height:225px; width:100%;">
                                        </div>
                                        <div class="panel-footer text-center">
