...
<div class="container">
    <h1 class="page-header text-center">CRUD ПРОДУКТОВ</h1>
    <div class="row">
        <div class="col-md-12">
                ...
                <?php
                    ...
                    while($row=$query->fetch_array()){
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#editproduct<?php echo $row['productid']; ?>" data-toggle="modal" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-pencil"></span> ИЗМЕНИТЬ</a> || <a href="#deleteproduct<?php echo $row['productid']; ?>" data-toggle="modal" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span> УДАЛИТЬ</a>
